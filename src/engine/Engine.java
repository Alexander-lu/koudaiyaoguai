...
public class Engine extends ConsoleProgram implements Backgroundmusic2 {
    ...
    Play talkWithDoctor = new Play("res//mp3/Pokemon-talkwithDoctor.mp3");//与博士对话

//    Play pokemonCave = new Play("res/mp3/Pokemon-cave.mp3");//进入山洞
//    Play Fight01 = new Play("res/mp3/Pokemon-fight.mp3");//野外精灵战斗1
//    Play Fight02 = new Play("res/mp3/Pokemon-fight2.mp3");//野外精灵战斗2
//    Play Fight03 = new Play("res/mp3/Pokemon-fight3.mp3");//野外精灵战斗3
//    Play gymFightSuccess01 = new Play("res/mp3/Pokemon-gymFightSuccess.mp3");//道馆战斗1
//    Play gymFightSuccess02 = new Play("res/mp3/Pokemon-gymFightSuccess02.mp3");//道馆战斗2
//    Play gymFightSuccess03 = new Play("res/mp3/Pokemon-gymFightSuccess03.mp3");//道馆战斗3
    Play outsideWalk01 = new Play("res/mp3/Pokemon-outsideWalk.mp3");//户外行走1
//    Play outsideWalk02 = new Play("res/mp3/Pokemon-outsideWalk02.mp3");//户外行走2
//    Play passengerFight = new Play("res/mp3/Pokemon-passengerFight.mp3");//路人战斗
//    Play pokemonRecovery = new Play("res/mp3/Pokemon-pokemonRecovery.mp3");//医疗中心恢复
    Play receiveItems = new Play("res/mp3/Pokemon-receiveItems.mp3");//获得道具
//    Play wildPokemonFightSuccess01 = new Play("res/mp3/Pokemon-wildPokemonFightSuccess.mp3");//野外精灵战斗胜利1
//    Play wildPokemonFightSuccess02 = new Play("res/mp3/Pokemon-wildPokemonFightSuccess.mp3");//野外精灵战斗胜利2
    /**
     * 定义窗口的宽度和高度
     */
            ...
            if (currPlace.getbianhao() == 15) {
                ...
                if (success) {
                    ...
                    if (success1) {
                        ...
                        if (success2) {
                            Pokemon 绿毛虫 = new Pokemon("绿毛虫", 3, "技能", 40, 20, 20);
                            battle(绿毛虫);
                            break;
                        } else {
                            Pokemon 小拉达 = new Pokemon("小拉达", 3, "技能", 40, 20, 20);
                            battle(小拉达);
                            break;
                        }
                    } else {
